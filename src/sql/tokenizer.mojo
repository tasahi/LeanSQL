...
from src.sql.uast import UAST_NAME, UAST_LITERAL_NUM, UAST_LITERAL_STR, UAST_SQL_SELECT, UAST_SQL_INSERT, UAST_SQL_WHERE, UAST_SQL_FROM, UAST_SQL_CREATE_TABLE, UAST_SQL_VALUES, UAST_SQL_STAR
