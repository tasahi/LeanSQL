...
from src.storage.serial import get_serial_type, serial_type_len, encode_value, decode_value
...
def test_serial_roundtrip() raises:
    ...
    # Test Text
    var val_txt = Value.of_text("🔥 Mojo LeanSQL 🔥")
    ...
    if dec_txt.to_string() != "🔥 Mojo LeanSQL 🔥":
        p.free()
