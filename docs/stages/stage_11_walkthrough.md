...
Stage 11 adds full-featured relational query mechanisms to SQLean, expanding query processing beyond standard flat queries into hierarchical, iterative, windowed, and reactive workflows in **100% pure Mojo**.
...
### New Test Suites
1. **Suite 16: Derived Tables & CTEs** ([`tests/test_suite_16_subqueries_cte.mojo`](file:///mnt/c/Documents/Mojo/SQLean/tests/test_suite_16_subqueries_cte.mojo))
...
2. **Suite 17: Window Functions** ([`tests/test_suite_17_window_funcs.mojo`](file:///mnt/c/Documents/Mojo/SQLean/tests/test_suite_17_window_funcs.mojo))
...
3. **Suite 18: Database Triggers** ([`tests/test_suite_18_triggers.mojo`](file:///mnt/c/Documents/Mojo/SQLean/tests/test_suite_18_triggers.mojo))
